...
<div class="site-section bg-light">
  ...
  <center><h2>עלינו</h2>
    <p class="pulling_right">
      ,הקונדיטוריה הוקמה עבור אנשים שרוצים ללמוד את מקצועות האפייה והקונדיטוריה ברמה ובסטנדרטים הגבוהים ביותר בעולם <br>
      .בלי להתפשר על צוות המורים, על תכוניות הלימוד, על הציוד המקצועי ועל חומרי הגלם <br>
      טובי השפים, הקונדיטורים ואנשי המקצוע הבולטים בתחומם, מרכיבים את סגל ההוראה המוביל, לצד שפים אורחים מהארץ ומחו״ל<br>
    </p>
     </center>
  ...
  <div class="container">
    <div class="owl-carousel owl-slide-3 owl-slide">
      <div class="testimony">
        ...
        שמרית אחראית על פיתוח המתכונים החדשים
